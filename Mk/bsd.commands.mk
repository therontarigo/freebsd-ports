...
PKG_REGISTER?=		${CHROOT_DO} ${PKG_BIN} ${PKG_ARGS_ROOT} register
...
PKG_ADD_ENV=		RUN_SCRIPTS=NO HANDLE_RC_SCRIPTS=NO
PKG_ADD?=		${SETENV} ${PKG_ADD_ENV} ${PKG_BIN} ${PKG_ARGS_ROOT} add
