...
do-autogenerate-plist:
	...
	@cd ${WRKSRC} && ${PORTENV} ${PEAR} install -n -f -P ${WRKDIR}/inst package.xml > /dev/null 2> /dev/null
...
do-install:
	@cd ${WRKSRC} && ${PORTENV} ${PEAR} install -n -f -P ${STAGEDIR} package.xml
...
show-depends: patch
	@${PORTENV} ${PEAR} package-dependencies ${WRKDIR}/package.xml
